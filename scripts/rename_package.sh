...
new_paths=("composeApp/src/androidMain/kotlin/$new_path" "shared/src/androidMain/kotlin/$new_path" "shared/src/commonMain/kotlin/$new_path" "shared/src/iosMain/kotlin/$new_path" "shared/src/commonMain/sqldelight/$new_path" "composeApp/src/commonMain/kotlin/co" "composeApp/src/iosMain/kotlin/$new_path" "composeApp/src/commonMain/sqldelight/$new_path")
delete_paths=("composeApp/src/androidMain/kotlin/co" "shared/src/androidMain/kotlin/co" "shared/src/commonMain/kotlin/co" "shared/src/iosMain/kotlin/co" "shared/src/commonMain/sqldelight/co" "composeApp/src/commonMain/kotlin/$new_path" "composeApp/src/iosMain/kotlin/co" "composeApp/src/commonMain/sqldelight/co")
